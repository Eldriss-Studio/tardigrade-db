...
| Storage | tdb-storage | 39 | Q4 round-trip, segment rollover, persistence, SynapticStore, TextStore (single + batch), DeletionLog, segment compaction (6) |
| Retrieval | tdb-retrieval | 60 | Per-token Top5Avg, SLB eviction, pipeline, SIMD dot product, owner filter, PerTokenConfig, corpus-mean tracking (3), refinement strategies — None/MeanCentered/LatentPrf (6) |
