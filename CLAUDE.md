...
>
> Total: 4 commits, 64 new ATs, all clippy/fmt/doc clean. Foundation gaps still open: M1.4 (shared-LLM benchmark — quantifies the architectural differentiator), M2.x (HTTP bridge + JS consumer for inkjs), M3.x (polish — checkpoints, scheduler, builder pattern, miette diagnostics, consumer demos).
