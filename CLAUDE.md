...
>
> Foundation gaps still open: M1.4 honesty follow-up (#118 — make the shared-LLM benchmark comparators real or remove them), M2.2 (consumer guide + Node.js example + generated TypeScript types), M3.x (polish — checkpoints, scheduler, builder pattern, miette diagnostics, consumer demos).
