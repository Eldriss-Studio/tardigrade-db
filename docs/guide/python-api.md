...
# ["Tomoko Nishida teaches swimming", "What did Tomoko Nishida do?", "Nishida Tomoko converted swimming at the Pilsen aquatic center"]
```
...
| `mem_read_tokens(tokens, k, owner)` | Direct token-level retrieval (skips Python encode/parse round-trip) |
